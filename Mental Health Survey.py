...
import os
os.chdir('C:\\Analytics\\MachineLearning\\Mental Health Survey')
...
# Covariance Matrix, comparision of variability between
...
# see how many people have been trated
plt.figure(figsize=(12,8))
...
g = sns.factorplot(x='family_history', y='treatment',hue='Gender',
                  data=train_df, kind='bar',ci=None, size=5, aspect=2,
                  legend_out = True)
...
# lets build a forest and comute the feature importance
